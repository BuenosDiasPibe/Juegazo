...
namespace Juegazo.EntityComponents
{
    public class CameraToEntityComponent : Component
    {
        ...
        public CameraToEntityComponent()
        { }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Camera.Instance.Position = Vector2.Lerp(Camera.Instance.Position, targetPosition, 0.05f * (float)gameTime.ElapsedGameTime.TotalSeconds * 60);
        }
    }
}